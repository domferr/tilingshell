...
class SnapAssistTileButton extends SnapAssistTile {
    ...
    constructor(params: {
        ...
        this._btn.connect("notify::hover", () => this.set_hover(this._btn.hover));
    }
...
class LayoutTileButtons extends LayoutWidget<SnapAssistTileButton> {
    ...
    buildTile(parent: Clutter.Actor, rect: Mtk.Rectangle, gaps: Clutter.Margin, tile: Tile): SnapAssistTileButton {
...
export default class OverriddenWindowMenu extends GObject.Object {
    ...
    static get(): OverriddenWindowMenu {
        if (this._instance === null) this._instance = new OverriddenWindowMenu();
    ...
    private newBuildMenu(window: Meta.Window) {
        ...
        layouts.forEach((lay, ind) => {
            ...
            const layoutWidget = new LayoutTileButtons(row, lay, hasGaps ? 2:0, layoutHeight, layoutWidth);
