...
export default class TilingShellExtensionPreferences extends ExtensionPreferences {
  ...
  fillPreferencesWindow(window: Adw.PreferencesWindow) {
    ...
    const innerGapsRow = this._buildSpinButtonRow(Settings.SETTING_INNER_GAPS, 'Inner gaps', 'Gaps between windows');
    ...
    const enableTilingSystemRow = this._buildSwitchRow(
      ...
      this._buildActivationKeysDropDown(Settings.get_tiling_system_activation_key(), (newVal: ActivationKey) =>
    ...
    const spanMultipleTilesRow = this._buildSwitchRow(
      ...
      this._buildActivationKeysDropDown(Settings.get_span_multiple_tiles_activation_key(), (newVal: ActivationKey) =>
    ...
    const editLayoutsBtn = this._buildButtonRow('Edit layouts', 'Edit layouts', 'Open the layouts editor', () =>
    ...
    buttons.append(
      this._buildLinkButton('Report a bug', 'https://github.com/domferr/tilingshell/issues/new?template=bug_report.md'),
    );
    buttons.append(
  ...
  _buildActivationKeysDropDown(value: ActivationKey, onSelected: (v: ActivationKey) => void, styleClass?: string) {
    ...
    const activationKeys = [ActivationKey.CTRL, ActivationKey.ALT, ActivationKey.SUPER];
...
const ShortcutSettingButton = class extends Gtk.Button {
  static {
    GObject.registerClass(
      {
        Properties: {
          shortcut: GObject.ParamSpec.string('shortcut', 'shortcut', 'The shortcut', GObject.ParamFlags.READWRITE, ''),
        },
        Signals: {
